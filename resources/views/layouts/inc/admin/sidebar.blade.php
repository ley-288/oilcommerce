<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item {{Request::is('admin/category*') ? 'active' : ''}}">
      ...
      <div class="collapse {{Request::is('admin/category*') ? 'show' : ''}}" id="cat">
    ...
    <li class="nav-item {{Request::is('admin/users*') ? 'active' : ''}}">
      ...
      <div class="collapse {{Request::is('admin/users*') ? 'show' : ''}}" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link {{Request::is('admin/users') || Request::is('admin/users/*/edit') ? 'active' : ''}}" href="{{url('admin/users')}}" href="{{url('admin/users')}}"> View Users </a></li>
