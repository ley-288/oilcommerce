...
<div class="loading-overlay">
    ...
    <img src='admin/images/loading.gif' class='mt-3 loading-gif' height='25' width='25' alt='RGM'>
</div>
...
<div class="py-5 advert-space">{{--TEST DIV--}}

    <div class="ad-block-space">{{--DELETABLE--}}
        <div class="advert">
            This is an advert
        </div>
        <div class="advert">
    ...
    <div class="article-block-space">{{--DELETABLE--}}
        <div class="py-5">
            <div class="container">
