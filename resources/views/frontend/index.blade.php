    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <h4 class="headline-spot racing-green color-green headline-font">Racing Green</h4>
                <div class="underline mx-auto"></div>
                <p>Vintage Motor Racing Magazine.</p>
                <p class="text-muted">Read through our articles and subscribe to add favourites.</p>
            </div>
