            ...
            <div class="col-md-12">
                <div class="p-3 shadow bg-white">
                    <h4 class="text-primary">
                        ...
                        <a href="{{url('/orders')}}" class="btn btn-danger btn-sm float-end text-white">Back</a>
                    </h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6>Order placed: {{$order->created_at->format('d-m-y h:i a')}}</h6>
                            <h6>Payment Method: {{$order->payment_mode}}</h6>
                            <h6 class="bordered p-2 text-success">
