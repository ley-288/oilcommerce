!(function (m) {
    ...
    m.jscroll = {
        defaults: {
            ...
            autoTriggerUntil: !1,
            loadingHtml:
                "<img src='admin/images/loading.gif' class='mt-3 loading-gif' height='30' width='30' alt='RGM'>",
            loadingFunction: !1,
            padding: 0,
            nextSelector: "a:last",
            contentSelector: "",
            ...
            v = function () {
                ...
                return (
                    ...
                    t
                        ...
                        .last()
                        .html(
                            '<div class="jscroll-loading d-flex justify-content-center" id="jscroll-loading">' +
                                s.loadingHtml +
                                "</div>"
                        )
                        .promise()
